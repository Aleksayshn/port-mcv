...
const ContactMe = () => {
    ...
    return (
        <Section>
            ...
            <OutletBox>
                {done ? <Message handleReset={handleReset} titleMessage="Thank you! 🤘" textMessage="Your message has been accepted. You will recieve answer really soon!" /> : <Box size={2}><FeedbackForm handleOnSubmit={handleOnSubmit} hendleSetParam={hendleSetParam} name={name} email={email} message={message} /></Box>}
