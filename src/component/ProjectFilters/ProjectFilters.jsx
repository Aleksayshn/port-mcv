    ...
    <Container>
      ...
      <Form onClick={hendleSetSelectedFilters}>
        <CheckBoxContainer>
          ...
          <CheckBoxLabel htmlFor="checkHTML">
        ...
        <CheckBoxContainer>
          ...
          <CheckBoxCustom></CheckBoxCustom>
          <CheckBoxLabel htmlFor="checkCSS">
        ...
        <CheckBoxContainer>
          ...
          <CheckBoxCustom></CheckBoxCustom>
          <CheckBoxLabel htmlFor="checkReact">
        ...
        <CheckBoxContainer>
          <CheckBoxInput id="checkNode" type="checkbox" name="Node" />
          <CheckBoxCustom></CheckBoxCustom>
          <CheckBoxLabel htmlFor="checkNode">
        ...
        <CheckBoxContainer>
          <CheckBoxInput id="checkJava" type="checkbox" name="Java" />
          <CheckBoxCustom></CheckBoxCustom>
          <CheckBoxLabel htmlFor="checkJava">
